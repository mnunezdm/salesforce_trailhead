...
import BOAT_NAME_TYPE from '@salesforce/schema/Boat__c.BoatType__c';
import BOAT_NAME_LENGTH from '@salesforce/schema/Boat__c.Length__c';
import BOAT_NAME_PRICE from '@salesforce/schema/Boat__c.Price__c';
import BOAT_NAME_DESCRIPTION from '@salesforce/schema/Boat__c.Description__c';
...
export default class BoatDetailTabs extends NavigationMixin(LightningElement) {
  ...
  boatType = BOAT_NAME_TYPE;
  boatLength = BOAT_NAME_LENGTH;
  boatPrice = BOAT_NAME_PRICE;
  boatDescription = BOAT_NAME_DESCRIPTION;
